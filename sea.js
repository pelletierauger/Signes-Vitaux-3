...
//     uv * 
    ...
    vec3 col = CircleRGB(uv, p2, 100.9, 0.2, vec3(0.25, 1.4, 1.0));
    vec2 newV = pow(uv.x, -1.5) * (uv + sin(uv.y * 13.0)) - (p + sin(uv.y * 10.));
    uv = vec2(sin(uv.x * 12.), cos(uv.y * 2.));
...
//     uv * 
    ...
    t *= 0.5;
    vec2 p = vec2(3.0, 4.0);
    vec2 p2 = vec2(0.0 + sin(uv.x) * 2., 0.0);
    vec3 col = CircleRGB(uv, p2, 100.9, 0.2, vec3(0.25, 1.4, 1.0));
    vec2 newV = pow(uv.x, -1.5) * (uv + sin(uv.y * 13.0)) - (p + sin(uv.y * 10.));
    uv = vec2(sin(uv.x * 12.), cos(uv.y * 2.));
    newV -= sin(uv * 0.01 + (uv * 10.0)) * t * sin(t * 2000.);
...
//     uv * 
    ...
    t *= 0.5;
    vec2 p = vec2(3.0, 4.0);
    vec2 p2 = vec2(0.0 + sin(uv.x) * cos(uv.y * 20. * t * 10.0) * 2., 0.0);
    vec3 col = CircleRGB(uv, p2, 100.9, 0.2, vec3(0.25, 1.4, 1.0));
    vec2 newV = pow(uv.x, -1.5) * (uv + sin(uv.y * 13.0)) - (p + sin(uv.y * 10.));
    uv = vec2(sin(uv.x * 12.), cos(uv.y * 2.));
    newV -= sin(uv * 0.01 + (uv * 10.0)) * t * sin(t * 2000.);
...
//     uv * 
    ...
    col *= cos(cos(atan(newV.x, newV.y) * (sin(t * 150.) * 0.75)) * 50.);
    col += CircleRGB(uv, p2 + vec2(0.0, -0.5), 1.14, 0.6, vec3(0.0, 0.2, 0.9));
    col += CircleRGB(uv, p2, 1.75, 0.6, vec3(0.5, 0.7, 0.0) * 0.75) * 3.;
    float rando = rand(uvf) * 0.1;
    col.g *= 0.35;
    gl_FragColor = vec4(col - rando, 1.0);
}
...
//     uv * 
    ...
    float t = time * 0.125 * 0.06125 * 0.5;
    t *= 0.5;
    vec2 p = vec2(10.0, 4.0);
    vec2 p2 = vec2(0.0 + sin(uv.x) + cos(uv.y * 20. * t * 10.0) * 2., 0.0);
    vec3 col = CircleRGB(uv, p2, 100.9, 0.2, vec3(0.25, 1.4, 2.0));
    vec2 newV = pow(uv.x, -1.5) * (uv + sin(uv.y * 13.0)) - (p + sin(uv.y * 10.));
    uv = vec2(sin(uv.x * 12.), cos(uv.y * 2.));
    newV -= sin(uv * 0.01 + (uv * 10.0)) * t * sin(t * 2000.);
    col *= cos(sin(atan(newV.x, newV.y) * (sin(t * 150.) * 0.75)) * 50.);
...
//     uv * 
    ...
    t *= 0.5;
    vec2 p = vec2(10.0, 4.0);
    vec2 p2 = vec2(0.0 + sin(uv.x * 10. + cos(uv.y * 10. * t * 10.0)) * 2., 0.0);
    vec3 col = CircleRGB(uv, p2, 100.9, 0.2, vec3(0.25, 1.4, 2.0));
    vec2 newV = pow(uv.x, -1.5) * (uv + sin(uv.y * 13.0)) - (p + sin(uv.y * 10.));
    uv = vec2(sin(uv.x * 12.), cos(uv.y * 2.));
    newV -= sin(uv * 0.01 + (uv * 10.0)) * t * sin(t * 2000.);
